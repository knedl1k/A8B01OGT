...
Cíl: $\lambda x + (1-\lambda) z \in H(y, \alpha)$.
...
Cíl: $|| [\lambda x + (1-\alpha)y] - a || \leq r$.
...
\[
    \varphi(x+y) = \varphi (2 (\frac{1}{2} (x+y))) \stackrel{(1)}{=} 2 \varphi (\frac{1}{2} (x+y)) = 
    2 [f(\frac{1}{2}x + \frac{1}{2}y) - f(0)] = 2 [\frac{1}{2} f(x) + \frac{1}{2}f(y) - f(0) ] = 
\]
\[
