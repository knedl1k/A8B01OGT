...
\begin{tikzpicture}
    ...
    \draw[thick,->, black!30!green] (1,0) -- (-1.5,1.5);
...
\vspace*{1.5em}
\bb{Definice.} Nechť $\Omega \subseteq \R^n$ je otevřená množina,
\[
...
\columnbreak
    ...
    \begin{flalign*}
        (2) &\implies d_2 \geq 0 &\\
        (1) &\implies d_2 \leq \alpha^2 d_1^3 \quad \forall \alpha > 0 \text{ dostatečně malé.}&
    \end{flalign*}
